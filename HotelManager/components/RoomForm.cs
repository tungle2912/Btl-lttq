...
namespace HotelManager.components
{
	public partial class RoomForm : Form
	{
		...
		private void cancelAddRoomFormButton_Click(object sender, EventArgs e)
		{
			CustomMessageBox c = new CustomMessageBox("Xác nhận", "Bạn có chắc chắn muốn hủy không?", "Yes", "No");
